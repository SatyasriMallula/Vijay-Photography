...
export default function TravelPage() {
  ...
  return (
    <div className="py-16 px-6 max-w-7xl mx-auto">
      ...
      >
        Traveling is more than just reaching a destination—it&apos;s about the
        stories, cultures, and experiences you gather along the way. From
        majestic mountains to vibrant city streets, each frame captures the
        spirit of adventure and discovery. Here&apos;s a glimpse into
