...
const navItems = [
    ...
    { href: "/portfolio", label: "Portfolio" },
    {
        ...
        dropdown: [
            ...
            { href: "/services/portraits", label: "Portraits" },
        ],
    },
        ...
        `}
            >
                <div className="max-w-8xl mx-auto w-full flex items-center justify-between px-6 py-3">
                    ...
                    <a
                        href="#home"
                        className="flex items-center gap-3 group cursor-pointer transition-transform duration-300 hover:scale-105 hover:-rotate-1"
                    >
                        <Image
                            src="/logo.png"
                        ...
                        <span className="ml-2 text-blue-200 font-semibold text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                            Capturing Moments
                        </span>
                    </a>
